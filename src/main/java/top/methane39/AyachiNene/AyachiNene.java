package top.methane39.AyachiNene;
...
import top.methane39.AyachiNene.entity.client.NeneRenderer;
import top.methane39.AyachiNene.entity.custom.Nene;
import top.methane39.AyachiNene.item.ModCreativeModTabs;
...
public class AyachiNene
{
    ...
    public static final String MODID = "ayachinene";
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            EntityRenderers.register(ModEntities.NENE.get(), NeneRenderer::new);
        }
    }
}
